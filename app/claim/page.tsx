      ...
      <div className="min-h-screen bg-slate-50">
        ...
        <div className="max-w-lg mx-auto px-4 py-16 text-center">
          ...
          <p className="text-slate-600 mb-6">
            This is a mock submission. In a real system your claim would now be processed by EPFO.
          </p>
          <div className="bg-white rounded-2xl border border-slate-200 p-5 text-left mb-8">
            ...
            <p className="font-mono text-sm text-epf-700">CLM-MOCK-{Date.now().toString().slice(-6)}</p>
          </div>
          <Link
            href="/dashboard"
            className="inline-flex items-center justify-center bg-epf-600 hover:bg-epf-700 text-white font-semibold px-6 py-3 rounded-xl"
          >
            Back to dashboard
          </Link>
        </div>
          ...
          {[1, 2, 3, 4].map((s) => (
            <div
              ...
              className={`h-1.5 flex-1 rounded-full ${
                s <= step ? "bg-epf-600" : "bg-slate-200"
              }`}
            />
          ))}
        </div>
          ...
          <div className="bg-amber-50 border border-amber-200 rounded-2xl p-4 mb-6 flex gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-amber-800 mt-1">
                Your account has KYC or name issues. We still let you continue so you can see the full flow, but in real life fix these first.
              </p>
            ...
            <div className="space-y-3">
              {[
                ...
                <button
                  ...
                  className="w-full text-left bg-white border border-slate-200 hover:border-epf-400 rounded-xl px-4 py-3.5 font-medium text-slate-900 transition"
                >
                  {type}
                </button>
              ))}
          ...
          <div className="space-y-5">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 rounded-xl border border-slate-300 focus:border-epf-500 focus:ring-2 focus:ring-epf-200 outline-none text-base"
              />
            </div>
            <div className="flex gap-3">
              <button
                type="button"
                onClick={() => setStep(1)}
                className="flex-1 py-3 rounded-xl border border-slate-300 font-medium text-slate-700"
              >
                Back
              </button>
              <button
                ...
                onClick={() => setStep(3)}
                className="flex-1 py-3 rounded-xl bg-epf-600 hover:bg-epf-700 disabled:opacity-50 text-white font-semibold"
              >
                Continue
              </button>
            </div>
          ...
          <div className="space-y-5">
            ...
            <div className="bg-white rounded-2xl border border-slate-200 p-4 space-y-3">
              ...
              <p className="text-sm text-slate-600">
                Money will be credited to this account after approval. (Mock – no real transfer.)
              </p>
            </div>
            <div className="flex gap-3">
              <button
              ...
              <button
                type="button"
                onClick={() => setStep(4)}
                className="flex-1 py-3 rounded-xl bg-epf-600 hover:bg-epf-700 text-white font-semibold"
              >
                Continue
              </button>
            </div>
        ...
        {step === 4 && (
          <div className="space-y-5">
            ...
            <p className="text-xs text-slate-500">
              This is a mock submission for the hackathon demo. No real claim is filed with EPFO.
            </p>
            <div className="flex gap-3">
              <button
                type="button"
