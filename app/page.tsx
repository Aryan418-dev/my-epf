...
import { Shield, ArrowRight, Smartphone, HelpCircle, CheckCircle2 } from "lucide-react";
      ...
      <main className="max-w-3xl mx-auto px-4 pb-16">
        <section className="mb-10">
          <h2 className="text-3xl sm:text-4xl font-bold text-slate-900 leading-tight mb-4">
            Check balance.<br />Track claims.<br />Know what to do next.
          </h2>
        ...
        <section className="grid gap-4 sm:grid-cols-3 mb-12">
          <div className="bg-white rounded-2xl border border-slate-200 p-5 shadow-sm">
            ...
            <p className="text-sm text-slate-600">Built for phones and slower connections.</p>
          </div>
          <div className="bg-white rounded-2xl border border-slate-200 p-5 shadow-sm">
            <HelpCircle className="w-8 h-8 text-epf-600 mb-3" />
            <h3 className="font-semibold text-slate-900 mb-1">Plain language</h3>
            <p className="text-sm text-slate-600">Clear reasons when something is stuck.</p>
          </div>
          <div className="bg-white rounded-2xl border border-slate-200 p-5 shadow-sm">
            <CheckCircle2 className="w-8 h-8 text-epf-600 mb-3" />
            <h3 className="font-semibold text-slate-900 mb-1">Guided claims</h3>
            <p className="text-sm text-slate-600">Step-by-step instead of confusing forms.</p>
          </div>
        </section>
        ...
        <section className="bg-slate-50 rounded-2xl border border-slate-200 p-6">
          ...
          <div className="space-y-2 text-sm text-slate-700">
            <p><span className="font-mono bg-white px-2 py-0.5 rounded border">100123456789</span> / demo123 — Clean account</p>
